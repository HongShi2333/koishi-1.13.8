...
__export(src_exports, {
  ...
  Eval: () => Eval,
  Field: () => Field,
  Logger: () => import_cordis2.Logger,
  Model: () => Model,
  Primary: () => Primary,
  RuntimeError: () => RuntimeError,
  Schema: () => import_cordis2.Schema,
  Selection: () => Selection,
  default: () => src_default,
...
var Executable = class {
  ...
  constructor(driver, payload) {
    ...
    (0, import_cosmokit2.defineProperty)(this, "model", driver.model(this.table));
    (0, import_cosmokit2.defineProperty)(this, "row", createRow(this.ref, {}, "", this.model));
  }
  resolveQuery(query = {}) {
  ...
  resolveFields(fields) {
    ...
    if (Array.isArray(fields)) {
      ...
      return (0, import_cosmokit2.valueMap)(fields, (field) => this.resolveField(field));
    }
  }
  async execute() {
...
var Model = class {
  ...
  checkIndex(index) {
    for (const key of (0, import_cosmokit3.makeArray)(index)) {
      if (!this.fields[key]) {
  ...
  resolveValue(key, value) {
    if ((0, import_cosmokit3.isNullable)(value))
      return value;
  ...
  create(data) {
    const result = {};
    const keys = (0, import_cosmokit3.makeArray)(this.primary);
    for (const key in this.fields) {
      const { initial, deprecated } = this.fields[key];
      if (deprecated)
        continue;
      if (!keys.includes(key) && !(0, import_cosmokit3.isNullable)(initial)) {
        result[key] = (0, import_cosmokit3.clone)(initial);
      }
    }
...
var Database = class extends import_cordis.Service {
  static {
...
var Driver = class {
  ...
  model(table) {
    ...
    if (table instanceof Selection) {
      ...
      model2.fields = (0, import_cosmokit5.valueMap)(table.args[0].fields, (_, key) => ({
        type: "expr"
      }));
      return model2;
    }
...
var queryOperators = {
  ...
  // existence
  $exists: (query, data) => query !== (0, import_cosmokit6.isNullable)(data),
  // comparison
...
function executeFieldQuery(query, data) {
  ...
  } else if ((0, import_cosmokit6.isNullable)(query)) {
    return (0, import_cosmokit6.isNullable)(data);
  }
