...
// external/webui/plugins/market/src/node/locales/schema.zh-CN.yml
var require_schema_zh_CN = __commonJS({
  "external/webui/plugins/market/src/node/locales/schema.zh-CN.yml"(exports, module2) {
...
// external/webui/plugins/market/src/node/locales/message.zh-CN.yml
var require_message_zh_CN = __commonJS({
  "external/webui/plugins/market/src/node/locales/message.zh-CN.yml"(exports, module2) {
...
// external/webui/plugins/market/src/node/index.ts
var node_exports = {};
...
// external/webui/plugins/market/src/node/deps.ts
var import_console = require("@koishijs/console");
var _DependencyProvider = class _DependencyProvider extends import_console.DataService {
  constructor(ctx) {
...
__name(_DependencyProvider, "DependencyProvider");
var DependencyProvider = _DependencyProvider;
var _RegistryProvider = class _RegistryProvider extends import_console.DataService {
  constructor(ctx) {
...
__name(_RegistryProvider, "RegistryProvider");
var RegistryProvider = _RegistryProvider;

// external/webui/plugins/market/src/node/installer.ts
...
var _Installer = class _Installer extends import_koishi.Service {
  constructor(ctx, config) {
    ...
    this.flushData = ctx.throttle(() => {
      var _a;
      (_a = ctx.get("console")) == null ? void 0 : _a.broadcast("market/registry", this.tempCache);
      this.tempCache = {};
    }, 500);
  }
  http;
  ...
  getPackage(name2) {
    var _a;
    return (_a = this.pkgTasks)[name2] || (_a[name2] = this._getPackage(name2));
  }
  async _getDeps() {
  ...
  getDeps() {
    return this.depTask || (this.depTask = this._getDeps());
  }
  refreshData() {
    var _a, _b;
    (_a = this.ctx.get("console")) == null ? void 0 : _a.refresh("registry");
    (_b = this.ctx.get("console")) == null ? void 0 : _b.refresh("packages");
  }
  ...
  async exec(args) {
    var _a, _b;
    const name2 = (_b = (_a = this.agent) == null ? void 0 : _a.name) != null ? _b : "npm";
      ...
      child.stdout.on("data", (data) => {
        ...
        for (const line of lines) {
          ...
          try {
            ...
            logger[(_a2 = levelMap[type]) != null ? _a2 : "info"](data2);
          } catch (error) {
            logger.warn(line);
            logger.warn(error);
          }
...
// external/webui/plugins/market/src/node/market.ts
var import_koishi2 = require("koishi");
var import_registry2 = __toESM(require("@koishijs/registry"));
var import_shared = require("../shared");
var _MarketProvider = class _MarketProvider extends import_shared.MarketProvider {
  constructor(ctx, config) {
    super(ctx);
    this.config = config;
    if (config.endpoint)
      ...
      this.scanner.analyze({
        ...
        onFailure: (name2, reason) => {
          ...
          if (registry.config.endpoint.startsWith("https://registry.npmmirror.com")) {
            if (import_koishi2.Quester.isAxiosError(reason) && ((_a = reason.response) == null ? void 0 : _a.status) === 404) {
            }
          }
        },
        ...
        onSuccess: (object, versions) => {
          var _a;
          (_a = object.package).links || (_a.links = {
...
__name(_MarketProvider, "MarketProvider");
var MarketProvider = _MarketProvider;
((MarketProvider2) => {
...
function apply(ctx, config) {
  ...
  ctx.inject(["installer"], (ctx2) => {
    ...
    ctx2.command("plugin.upgrade [name...]", { authority: 4 }).alias(".update", ".up").option("self", "-s, --koishi").action(async ({ session, options }, ...names) => {
      ...
      if (!["Y", "y"].includes(result == null ? void 0 : result.trim())) {
  ...
  ctx.inject(["console", "installer"], (ctx2) => {
    ...
    ctx2.console.addListener("market/install", async (deps, forced) => {
      ...
      (_a2 = ctx2.get("console")) == null ? void 0 : _a2.refresh("dependencies");
      (_b = ctx2.get("console")) == null ? void 0 : _b.refresh("registry");
      (_c = ctx2.get("console")) == null ? void 0 : _c.refresh("packages");
      return code;
    }, { authority: 4 });
