...
__publicField(_Loader, "kRecord", Symbol.for("koishi.loader.record"));
__publicField(_Loader, "exitCode", 51);
__publicField(_Loader, "extensions", new Set(Object.keys(writable)));
var Loader = _Loader;
