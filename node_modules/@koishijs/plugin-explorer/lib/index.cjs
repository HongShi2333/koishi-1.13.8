...
// external/webui/plugins/explorer/src/index.ts
var src_exports = {};
  ...
  constructor(ctx, config) {
    ...
    ctx.console.addListener("explorer/read", async (filename, binary) => {
      ...
      return {
        ...
        mime: result == null ? void 0 : result.mime,
