...
export abstract class Console extends Service {
    ...
    refresh<K extends keyof Console.Services>(type: K): Promise<void>;
    patch<K extends keyof Console.Services>(type: K, value: Console.Services[K] extends DataService<infer T> ? T : never): void;
}
