...
// src/index.ts
import { Context as Context3, Service as Service2, valueMap } from "koishi";
...
var Console = class extends Service2 {
  ...
  addEntry(files, data) {
    return new Entry(this[Context3.current], files, data);
  }
  ...
  patch(type, value) {
    return this.ctx.get(`console.${type}`)?.patch(value);
  }
};
