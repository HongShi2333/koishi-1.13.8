...
// external/webui/plugins/config/src/shared/index.ts
var shared_exports = {};
...
// external/webui/plugins/config/src/shared/packages.ts
var import_koishi = require("koishi");
var import_console = require("@koishijs/console");
var logger = new import_koishi.Logger("config");
var _PackageProvider = class _PackageProvider extends import_console.DataService {
  constructor(ctx) {
  ...
  async get(forced = false) {
    ...
    for (const object of objects) {
      object.name = ((_a = object.package) == null ? void 0 : _a.name) || "";
  ...
  async parseExports(name) {
    try {
      ...
      const inject = (exports == null ? void 0 : exports.using) || (exports == null ? void 0 : exports.inject) || [];
...
var PackageProvider = _PackageProvider;

// external/webui/plugins/config/src/shared/services.ts
var import_console2 = require("@koishijs/console");
var import_koishi2 = require("koishi");
var _ServiceProvider = class _ServiceProvider extends import_console2.DataService {
  constructor(ctx) {
    super(ctx, "services");
    ...
    const attach = /* @__PURE__ */ __name((internal) => {
      ...
      for (const [key, { type }] of Object.entries(internal)) {
        ...
        if (!(instance instanceof Object))
          continue;
        const ctx = (_a = Reflect.getOwnPropertyDescriptor(instance, import_koishi2.Context.current)) == null ? void 0 : _a.value;
        if (!ctx)
          continue;
...
__name(_ServiceProvider, "ServiceProvider");
var ServiceProvider = _ServiceProvider;

// external/webui/plugins/config/src/shared/writer.ts
...
var _ConfigWriter = class _ConfigWriter extends import_console3.DataService {
  loader;
  constructor(ctx) {
  ...
  getGroup(plugins, ctx) {
    ...
    for (const key in plugins) {
      ...
      if (!this.loader.isTruthyLike(value == null ? void 0 : value.$if)) {
        delete result[key];
        continue;
      }
  ...
  async teleport(source, key, target, index) {
    ...
    const fork = (_a = parentS == null ? void 0 : parentS[import_loader.Loader.kRecord]) == null ? void 0 : _a[key];
...
__name(_ConfigWriter, "ConfigWriter");
var ConfigWriter = _ConfigWriter;
