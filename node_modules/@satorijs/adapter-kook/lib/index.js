...
function adaptMessageMeta(base, data, message = {}, payload = message) {
  ...
  if (base.type === 1 /* text */) {
    ...
    const element = (0, import_satori.h)("img", { src: base.content, file: (_a = data.attachments) == null ? void 0 : _a.name });
...
// satori/adapters/kook/src/message.ts
...
var _KookMessageEncoder = class _KookMessageEncoder extends import_satori4.MessageEncoder {
  path;
  params = {};
  additional = {};
  textBuffer = "";
...
__name(_KookMessageEncoder, "KookMessageEncoder");
var KookMessageEncoder = _KookMessageEncoder;
((KookMessageEncoder2) => {
...
// satori/adapters/kook/src/bot.ts
var _KookBot = class _KookBot extends import_satori5.Bot {
  http;
  internal;
...
__name(_KookBot, "KookBot");
__publicField(_KookBot, "MessageEncoder", KookMessageEncoder);
__publicField(_KookBot, "inject", ["http"]);
var KookBot = _KookBot;
((KookBot2) => {
