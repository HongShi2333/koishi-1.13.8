...
var TelegramMessageEncoder = class extends import_satori2.MessageEncoder {
  static {
...
var HttpPolling = class extends import_satori4.Adapter {
  static {
    ...
    bot.initialize(async () => {
      ...
      const polling = /* @__PURE__ */ __name(async () => {
        try {
          ...
          if (!import_satori4.Quester.Error.is(e) || !e.response?.data) {
...
((HttpPolling2) => {
  HttpPolling2.Options = import_satori4.Schema.object({
...
var TelegramBot = class _TelegramBot extends import_satori5.Bot {
  static {
  ...
  async $getFileFromPath(filePath) {
    ...
    if (mime === "application/octet-stream") {
      mime = (await import_file_type.default.fromBuffer(data))?.mime;
    }
