...
// src/index.ts
import { Context as Context4, Logger as Logger2, Service, z as z2 } from "cordis";
import { defineProperty as defineProperty2, makeArray, remove as remove3 } from "cosmokit";
...
var Bot = class {
  constructor(ctx, config, platform) {
    ...
    const self = Context2.associate(this, "bot");
    ctx.bots.push(self);
...
defineProperty2(HTTP, "Config", z2.object({
...
var Satori = class extends Service {
  static {
    __name(this, "Satori");
  }
