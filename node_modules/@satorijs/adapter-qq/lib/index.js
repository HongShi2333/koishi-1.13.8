...
// satori/adapters/qq/src/index.ts
var src_exports = {};
...
// satori/adapters/qq/src/types.ts
var types_exports = {};
...
// satori/adapters/qq/src/ws.ts
var import_satori2 = require("@satorijs/satori");

// satori/adapters/qq/src/utils.ts
var import_satori = require("@satorijs/satori");
var import_element = require("@satorijs/element");
...
function decodeGroupMessage(bot, data, message = {}, payload = message) {
  ...
  for (const attachment of (_a = data.attachments) != null ? _a : []) {
...
async function decodeMessage(bot, data, message = {}, payload = message) {
  ...
  message.content = ((_a = data.content) != null ? _a : "").replace(/<@!(\d+)>/g, (_, $1) => import_satori.h.at($1).toString());
  ...
  message.elements = import_satori.h.transform(message.elements, {
    text: (attrs) => (0, import_element.unescape)(attrs.content)
  });
...
async function adaptSession(bot, input) {
  ...
  if (input.t === "MESSAGE_CREATE" || input.t === "AT_MESSAGE_CREATE" || input.t === "DIRECT_MESSAGE_CREATE") {
    ...
    session.userId = (_b = (_a = input.d.group_member_openid) != null ? _a : input.d.user_openid) != null ? _b : input.d.data.resolved.user_id;
...
// satori/adapters/qq/src/ws.ts
var _WsClient = class _WsClient extends import_satori2.Adapter.WsClient {
  _sessionId = "";
  _s = null;
  _ping;
  async prepare() {
...
// satori/adapters/qq/src/bot/guild.ts
var import_satori5 = require("@satorijs/satori");

// satori/adapters/qq/src/internal/internal.ts
        ...
        for (const name of (0, import_satori3.makeArray)(routes[path][method])) {
          (isGuild ? GuildInternal : GroupInternal).prototype[name] = async function(...args) {
            ...
            try {
              ...
              if (!import_satori3.Quester.isAxiosError(error) || !error.response)
                throw error;
...
var _GroupInternal = class _GroupInternal extends Internal {
};
__name(_GroupInternal, "GroupInternal");
var GroupInternal = _GroupInternal;
var _GuildInternal = class _GuildInternal extends Internal {
};
__name(_GuildInternal, "GuildInternal");
var GuildInternal = _GuildInternal;

// satori/adapters/qq/src/internal/group.ts
...
// satori/adapters/qq/src/internal/guild.ts
...
var _QQGuildMessageEncoder = class _QQGuildMessageEncoder extends import_satori4.MessageEncoder {
  content = "";
  file;
  filename;
  fileUrl;
  ...
  async flush() {
    ...
    let msg_id = (_b = (_a = this.options) == null ? void 0 : _a.session) == null ? void 0 : _b.messageId;
    if (((_c = this.options) == null ? void 0 : _c.session) && Date.now() - ((_e = (_d = this.options) == null ? void 0 : _d.session) == null ? void 0 : _e.timestamp) > MSG_TIMEOUT) {
      msg_id = null;
    }
    if (this.passiveId)
    ...
    try {
      if (useFormData) {
        ...
        if (((_f = this.options) == null ? void 0 : _f.session) && msg_id) {
      ...
      if (import_satori4.Quester.isAxiosError(e)) {
    ...
    } else if ((r == null ? void 0 : r.code) === 304023 && this.bot.config.parent.intents & 134217728 /* MESSAGE_AUDIT */) {
      try {
...
__name(_QQGuildMessageEncoder, "QQGuildMessageEncoder");
var QQGuildMessageEncoder = _QQGuildMessageEncoder;
var MSG_TIMEOUT = 5 * 60 * 1e3 - 2e3;
var _QQMessageEncoder = class _QQMessageEncoder extends import_satori4.MessageEncoder {
  content = "";
  passiveId;
  passiveSeq;
  useMarkdown = false;
  ...
  async flush() {
    ...
    this.trimButtons();
    let msg_id, msg_seq;
    if (((_b = (_a = this.options) == null ? void 0 : _a.session) == null ? void 0 : _b.messageId) && Date.now() - this.options.session.timestamp < MSG_TIMEOUT) {
      (_c = this.options.session)["seq"] || (_c["seq"] = 0);
  ...
  async sendFile(type, attrs) {
    var _a;
    let url = attrs.src || attrs.url, entry;
    ...
    (_a = entry == null ? void 0 : entry.dispose) == null ? void 0 : _a.call(entry);
    this.retry = false;
    return res;
  }
...
__name(_QQMessageEncoder, "QQMessageEncoder");
var QQMessageEncoder = _QQMessageEncoder;

// satori/adapters/qq/src/bot/guild.ts
var _QQGuildBot = class _QQGuildBot extends import_satori5.Bot {
  hidden = true;
  internal;
  http;
  ...
  async createDirectChannel(id, guild_id) {
    ...
    if (guild_id == null ? void 0 : guild_id.includes("_"))
...
__name(_QQGuildBot, "QQGuildBot");
__publicField(_QQGuildBot, "MessageEncoder", QQGuildMessageEncoder);
var QQGuildBot = _QQGuildBot;

// satori/adapters/qq/src/bot/index.ts
var _QQBot = class _QQBot extends import_satori6.Bot {
  guildBot;
  internal;
  groupHttp;
  guildHttp;
  ...
  async _ensureAccessToken() {
    const result = await this.ctx.http.post("https://bots.qq.com/app/getAppAccessToken", {
...
__name(_QQBot, "QQBot");
__publicField(_QQBot, "MessageEncoder", QQMessageEncoder);
__publicField(_QQBot, "inject", ["http"]);
var QQBot = _QQBot;
((QQBot2) => {
