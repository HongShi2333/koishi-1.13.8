import { Bot, Context, Session, Universal } from '@satorijs/satori';
...
export declare function setupReaction(session: Session, data: QQ.MessageReaction): Session<Context>;
export declare function adaptSession<C extends Context = Context>(bot: QQBot<C>, input: QQ.DispatchPayload): Promise<C[typeof Context.session]>;
