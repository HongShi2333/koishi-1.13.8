...
// external/webui/external/dataview/src/index.ts
var src_exports = {};
...
// external/webui/external/dataview/src/utils.ts
...
// external/webui/external/dataview/src/index.ts
var import_meta = {};
var _DatabaseProvider = class _DatabaseProvider extends import_console.DataService {
  task;
...
__publicField(_DatabaseProvider, "inject", ["console", "database"]);
