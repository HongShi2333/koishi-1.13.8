import{send as y0,message as q,store as T,useConfig as l0,pick as e0,router as w0,icons as N,Schema as M}from"../client.js";import{defineComponent as r0,reactive as c0,computed as k,watchEffect as n0,watch as Q,ref as F,onMounted as k0,resolveComponent as v,resolveDirective as x0,withDirectives as z0,openBlock as f,createElementBlock as y,createElementVNode as m,toDisplayString as I,unref as E,createVNode as p,withCtx as g,createTextVNode as J,Fragment as $0,renderList as S0,createBlock as j,withModifiers as X,resolveDynamicComponent as o0,mergeProps as a0,nextTick as V0,createCommentVNode as M0,KeepAlive as L0,createStaticVNode as O0}from"../vue.js";import{useRoute as D0}from"../vue-router.js";function R0(o){return o instanceof Date?`"d${o.toJSON()}"`:JSON.stringify(o,(l,t)=>{if(typeof t=="string")return"s"+t;if(typeof t=="object"){if(t instanceof Date)return"d"+new Date(t).toJSON();if(t===null)return null;const C=Array.isArray(t)?[]:{};for(const u in t)t[u]instanceof Date?(C[u]=new Date(t[u]),C[u].toJSON=void 0):C[u]=t[u];return C}return t})}function j0(o){if(o!==void 0)return JSON.parse(o,(l,t)=>typeof t=="string"?t[0]==="s"?t.slice(1):new Date(t.slice(1)):t)}async function A(o,...l){return j0(await y0(`database/${o}`,...l.map(R0)))}function i0(o){const l=["B","KB","MB","GB"];for(const t in l)if(t&&o>1024)o/=1024;else return`${+o.toFixed(1)} ${l[t]}`;return`${+o.toFixed(1)} ${l[l.length-1]}`}function Y(o,l=""){return console.warn(o),l.length&&(l+="\uFF1A"),o instanceof Error?l+=o.name:typeof o=="string"&&(l+=o.split(`
`)[0]),q.error(l)}function t0(o){return o.toString().padStart(2,"0")}function s0(o){return[t0(o.getHours()),t0(o.getMinutes()),t0(o.getSeconds())].join(":")}const B0={class:"content-right"},T0={class:"header"},I0={class:"table-title"},J0={class:"operations"},N0={key:0},U0={key:1},A0=["onParentDblclick"],E0=r0({__name:"data-table",props:{name:{},filter:{type:Boolean},color:{type:Boolean}},setup(o,{expose:l}){const t=c0({loading:true,pageSize:void 0,offset:0,sort:null,changes:{},newRow:{}}),C=[30,50,100,150,200,500,1e3],u=o,i=k(()=>T.database.tables[u.name]);n0(()=>{t.pageSize=t.pageSize||C[0]}),Q(()=>t.pageSize,c=>{t.offset=Math.floor(t.offset/c)*c},{}),Q(()=>i.value.fields,c=>{for(const e in i.value.fields)e in t.newRow||(t.newRow[e]="")},{immediate:true});const U=F([]);Q(()=>U.value.length,c=>{c&&U.value[c-1].focus()});const S=F([]);async function L(){if(!u.name)return;t.loading=true;const c=t.sort&&{[t.sort.field]:{ascending:"asc",descending:"desc"}[t.sort.order]},e={offset:t.offset,limit:t.pageSize,sort:c};try{const n=u.filter?Object.keys(t.newRow).reduce((s,a)=>(t.newRow[a]&&(s[a]=t.newRow[a],s[a]=Z(a,s[a])),s),{}):{};S.value=await A("get",u.name,n,e)}catch{}await V0(),t.loading=false}n0(L);const O=l0(),H=k(()=>u0(O.value));function h({column:c}){var e,n,s,a;if(!u.color)return c.cellStyle=void 0;if(c.cellStyle)return c.cellStyle;for(const r of((e=H.value.dataview)==null?void 0:e.colors)??[])if(!(!r||!r.types)&&r.types.includes((a=(s=(n=i.value)==null?void 0:n.fields)==null?void 0:s[c.label])==null?void 0:a.type))return c.cellStyle={"background-color":r.color};return c.cellStyle={}}l({updateData:L}),k0(()=>A("stats"));const w=k({get:()=>Math.floor(t.offset/t.pageSize)+1,set:c=>t.offset=(c-1)*t.pageSize}),x=k(()=>{var e;const c={};for(const n in t.changes||{})for(const s in t.changes[n]){const a=V.value[s];(e=a.attrs)!=null&&e.validate&&!a.attrs.validate(t.changes[n][s].model)||(c[n]||(c[n]={}),c[n][s]=t.changes[n][s])}return c}),D=k(()=>!!Object.keys(t.changes||{}).length),K=k(()=>!!Object.keys(x.value||{}).length),W=k(()=>{var c;for(const e in i.value.fields){const n=V.value[e];if((c=n.attrs)!=null&&c.validate&&!n.attrs.validate(t.newRow[e]))return console.log(e),false}return true}),V=k(()=>Object.keys(i.value.fields).reduce((c,e)=>{const n=i.value.fields[e],s={clearable:false};let a,r;switch(n.type){case"time":return{...c,[e]:{is:"el-time-picker",attrs:s}};case"date":return{...c,[e]:{is:"el-date-picker",attrs:{...s,type:"date"}}};case"timestamp":return{...c,[e]:{is:"el-date-picker",attrs:{...s,type:"datetime"}}};case"integer":case"unsigned":r=1;case"float":case"double":case"decimal":a="number";break;default:a="text";break}const $=b=>{if(n.nullable===false&&!b.length)return false;switch(a.value==="number"&&(b=parseFloat(b)),n.type){case"unsigned":if(b<0)return false;case"integer":if(b%1!=0)return false;break;case"json":if(b==="")return true;if(!b.startsWith("{")||!b.endsWith("}"))return false;break}return true};return c[e]={is:"el-input",attrs:{type:a,validate:$,step:r}},c},{}));function z(c){c.order===null?t.sort=null:t.sort={field:c.prop,order:c.order}}function P(c,{row:e,column:n,$index:s}){const a=i.value.fields[c].type,r=e[c];switch(a){case"json":return JSON.stringify(r);case"date":if(r instanceof Date)return r.toJSON().slice(0,10);break;case"time":if(r instanceof Date)return s0(r);break;case"timestamp":if(r instanceof Date)return`${r.toJSON().slice(0,10)} ${s0(r)}`;break}return r}function d0(c,e){switch(i.value.fields[c].type){case"json":return JSON.stringify(e);case"time":if(typeof e!="string")return e;const[s,a,r]=e.split(":"),$=new Date;return $.setHours(parseInt(s),parseInt(a),parseInt(r)),$}return e}function Z(c,e){switch(i.value.fields[c].type){case"unsigned":case"integer":case"float":case"double":return+e;case"boolean":case"list":case"json":return JSON.parse(e)}return e}function G({row:c,column:e,$index:n},s=true){var a,r,$,b;return((r=(a=t.changes)==null?void 0:a[n])==null?void 0:r[e.label])===void 0?false:s?((b=($=t.changes)==null?void 0:$[c.id])==null?void 0:b[e.label].model.value)!==c[e.label]:true}function f0(c,e,n){var s;(s=n.querySelector(".inner-cell"))==null||s.dispatchEvent(new Event("parent-dblclick"))}function g0({row:c,column:e,$index:n}){G({row:c,column:e,$index:n},false)||(t.changes[n]===void 0&&(t.changes[n]={}),t.changes[n][e.label]=c0({model:d0(e.label,c[e.label])}))}function p0({column:c,$index:e}){delete t.changes[e][c.label],Object.keys(t.changes[e]).length||delete t.changes[e]}function _0(){t.changes={}}async function m0(){t.loading=true;const c=[];for(const e in x.value)try{const n=S.value[e],s={};for(const a in x.value[e])s[a]=x.value[e][a].model,s[a]=Z(a,s[a]);console.log("Update row: ",s),await A("set",u.name,e0(n,i.value.primary),s);for(const a in x.value[e])c.push({idx:e,field:a})}catch(n){Y(n,"\u66F4\u65B0\u6570\u636E\u5931\u8D25")}for(const e of c)delete t.changes[e.idx][e.field];for(const e in t.changes)Object.keys(t.changes[e]).length||delete t.changes[e];await L(),c.length&&q.success(`\u6210\u529F\u4FEE\u6539 ${c.length} \u9879\u6570\u636E`),t.loading=false}async function h0({row:c,$index:e}){t.loading=true;try{await A("remove",u.name,e0(c,i.value.primary)),await L(),q.success("\u6210\u529F\u5220\u9664\u6570\u636E")}catch(n){Y(n,"\u6570\u636E\u5220\u9664\u5931\u8D25")}t.loading=false}async function b0(){t.loading=true;try{const c=Object.keys(t.newRow).reduce((e,n)=>(t.newRow[n]&&(e[n]=t.newRow[n],e[n]=Z(n,e[n])),e),{});console.log("Create row: ",c),await A("create",u.name,c),await L(),q.success("\u6210\u529F\u6DFB\u52A0\u6570\u636E");for(const e in t.newRow)t.newRow[e]=""}catch(c){Y(c,"\u6DFB\u52A0\u6570\u636E\u5931\u8D25")}t.loading=false}return(c,e)=>{const n=v("el-button"),s=v("k-icon"),a=v("k-button"),r=v("el-table-column"),$=v("el-popconfirm"),b=v("el-table"),C0=v("el-pagination"),v0=x0("loading");return z0((f(),y("div",B0,[m("div",T0,[m("span",I0,I(c.name)+" "+I(i.value.size?`(${E(i0)(i.value.size)})`:""),1),m("div",J0,[D.value?(f(),y("span",N0,[p(n,{type:"primary",disabled:!K.value,onClick:m0},{default:g(()=>[J("\u5E94\u7528\u4FEE\u6539")]),_:1},8,["disabled"]),p(n,{type:"danger",onClick:_0},{default:g(()=>[J("\u53D6\u6D88\u4FEE\u6539")]),_:1})])):(f(),y("span",U0,"\u53CC\u51FB\u5355\u5143\u683C\u4FEE\u6539\u6570\u636E"))])]),p(b,{data:S.value,class:"data-table",style:{width:"100%"},height:"100%",border:true,"cell-class-name":({row:_,column:d,rowIndex:R,columnIndex:D1})=>G({row:_,column:d,$index:R},false)?"cell-changed":"","cell-style":h,onSortChange:z,onCellDblclick:f0},{default:g(()=>[(f(true),y($0,null,S0(Object.keys(i.value.fields),_=>(f(),j(r,{sortable:D.value?false:"custom",prop:_,label:_,fixed:i.value.primary.includes(_),resizable:true},{header:g(({column:d})=>[J(I(d.label)+" ",1),m("div",{class:"insertion",onClick:e[1]||(e[1]=X(()=>{},["stop"]))},[(f(),j(o0(V.value[d.label].is),a0({onClick:e[0]||(e[0]=X(()=>{},["stop"])),modelValue:t.newRow[d.label],"onUpdate:modelValue":R=>t.newRow[d.label]=R},V.value[d.label].attrs||{},{size:"small"}),null,16,["modelValue","onUpdate:modelValue"]))])]),default:g(d=>[G(d,false)?(f(),j(o0(V.value[d.column.label].is),a0({key:0,ref_for:true,ref_key:"changedCells",ref:U,modelValue:t.changes[d.$index][d.column.label].model,"onUpdate:modelValue":R=>t.changes[d.$index][d.column.label].model=R},V.value[d.column.label].attrs||{},{size:"small"}),{suffix:g(()=>[p(a,{frameless:"",type:"danger",onClick:R=>p0(d)},{default:g(()=>[p(s,{name:"times-full"})]),_:2},1032,["onClick"])]),_:2},1040,["modelValue","onUpdate:modelValue"])):(f(),y("div",{key:1,onParentDblclick:R=>g0(d),class:"inner-cell"},I(P(_,d)),41,A0))]),_:2},1032,["sortable","prop","label","fixed"]))),256)),p(r,{label:"\u64CD\u4F5C",width:"60",fixed:"right",align:"center"},{header:g(({column:_})=>[J(I(_.label)+" ",1),m("div",{class:"insertion",onClick:e[2]||(e[2]=X(()=>{},["stop"]))},[p(a,{frameless:"",disabled:!W.value||D.value,onClick:b0},{default:g(()=>[J("\u63D2\u5165")]),_:1},8,["disabled"])])]),default:g(_=>[p($,{onConfirm:d=>h0(_),title:"\u771F\u7684\u8981\u5220\u9664\u8FD9\u6761\u6570\u636E\u5417\uFF1F","confirm-button-text":"\u662F","cancel-button-text":"\u5426"},{reference:g(()=>[p(a,{frameless:"",type:"danger",disabled:D.value},{default:g(()=>[p(s,{name:"times-full"})]),_:1},8,["disabled"])]),_:2},1032,["onConfirm"])]),_:1})]),_:1},8,["data","cell-class-name"]),p(C0,{layout:"total, sizes, prev, pager, next, jumper",small:true,total:i.value.count,"page-sizes":C,"default-page-size":C[0],"page-size":t.pageSize,"onUpdate:pageSize":e[3]||(e[3]=_=>t.pageSize=_),"default-current-page":1,"current-page":w.value,"onUpdate:currentPage":e[4]||(e[4]=_=>w.value=_),disabled:D.value},null,8,["total","default-page-size","page-size","current-page","disabled"])])),[[v0,t.loading]])}}});const B=(o,l)=>{const t=o.__vccOpts||o;for(const[C,u]of l)t[C]=u;return t},F0=B(E0,[["__scopeId","data-v-85bc7f98"]]),H0={key:0},P0=m("div",null,"\u5728\u5DE6\u4FA7\u9009\u62E9\u8981\u8BBF\u95EE\u7684\u6570\u636E\u8868",-1),q0=r0({__name:"index",setup(o){var H;function l(h){return Array.isArray(h)?h.join("/"):h||""}const t=F(),C=D0(),u=l0(),i=F(false),U=k(()=>i.value?"filter-off":"filter-on"),S=F(((H=u.value.dataview)==null?void 0:H.color)??false),L=k(()=>S.value?"rgb-off":"rgb-on"),O=k({get(){const h=l(C.params.name);return T.database.tables[h]?h:""},set(h){T.database.tables[h]||(h=""),w0.replace("/database/"+h)}});return(h,w)=>{const x=v("k-icon"),D=v("k-tab-group"),K=v("el-scrollbar"),W=v("k-empty"),V=v("k-layout");return f(),j(V,{class:"page-database"},{header:g(()=>{var z;return[J(" \u6570\u636E\u5E93 "),(z=E(T).database)!=null&&z.size?(f(),y("span",H0,"("+I(E(i0)(E(T).database.size))+")",1)):M0("v-if",true)]}),menu:g(()=>[m("span",{class:"menu-item",onClick:w[0]||(w[0]=z=>S.value=!S.value)},[p(x,{class:"menu-icon",name:L.value},null,8,["name"])]),m("span",{class:"menu-item",onClick:w[1]||(w[1]=z=>i.value=!i.value)},[p(x,{class:"menu-icon",name:U.value},null,8,["name"])]),m("span",{class:"menu-item",onClick:w[2]||(w[2]=z=>{var P;return(P=t.value)==null?void 0:P.updateData()})},[p(x,{class:"menu-icon",name:"refresh"})])]),left:g(()=>[p(K,null,{default:g(()=>[p(D,{data:E(T).database.tables,modelValue:O.value,"onUpdate:modelValue":w[3]||(w[3]=z=>O.value=z)},null,8,["data","modelValue"])]),_:1})]),default:g(()=>[(f(),j(L0,null,[O.value?(f(),j(F0,{key:O.value,name:O.value,filter:i.value,color:S.value,ref_key:"table",ref:t},null,8,["name","filter","color"])):(f(),j(W,{key:0},{default:g(()=>[P0]),_:1}))],1024))]),_:1})}}});const K0={},W0={class:"k-icon",xmlns:"http://www.w3.org/2000/svg",viewBox:"0 0 448 512"},Z0=m("path",{fill:"currentColor",d:"M224 512C100.3 512 0 476.2 0 432V80C0 35.82 100.3 0 224 0C347.7 0 448 35.82 448 80V432C448 476.2 347.7 512 224 512zM416 80.45C415.7 79.69 414.4 77.27 409.8 73.31C402.4 67.11 389.9 60.09 371.6 53.57C335.4 40.62 283.2 32 224 32C164.8 32 112.6 40.62 76.37 53.57C58.1 60.09 45.59 67.11 38.25 73.31C33.55 77.27 32.29 79.69 32 80.45V182.1C46.47 192.7 69.9 202.8 100.9 210.4C135.5 218.9 177.1 224 224 224C270 224 312.5 218.9 347.1 210.4C378.1 202.8 401.5 192.7 416 182.1V80.45zM416 219.5C398.8 228.4 377.9 235.8 354.8 241.5C317.3 250.7 272.2 256 224 256C175.8 256 130.7 250.7 93.22 241.5C70.11 235.8 49.18 228.4 32 219.5V310.1C46.47 320.7 69.9 330.8 100.9 338.4C135.5 346.9 177.1 352 224 352C270 352 312.5 346.9 347.1 338.4C378.1 330.8 401.5 320.7 416 310.1V219.5zM38.25 438.7C45.59 444.9 58.1 451.9 76.37 458.4C112.6 471.4 164.8 480 224 480C283.2 480 335.4 471.4 371.6 458.4C389.9 451.9 402.4 444.9 409.8 438.7C414.4 434.7 415.7 432.3 416 431.6V347.5C398.8 356.4 377.9 363.8 354.8 369.5C317.3 378.7 272.2 384 224 384C175.8 384 130.7 378.7 93.22 369.5C70.11 363.8 49.18 356.4 32 347.5V431.6C32.29 432.3 33.55 434.7 38.25 438.7zM416 431.4C416.1 431.3 416.1 431.3 416.1 431.3L416 431.4zM31.96 431.4C31.94 431.3 31.93 431.3 31.92 431.3L31.96 431.4zM31.96 80.56C31.93 80.65 31.92 80.7 31.92 80.7L31.96 80.56zM416.1 80.7C416.1 80.7 416.1 80.65 416 80.56z"},null,-1),G0=[Z0];function Q0(o,l){return f(),y("svg",W0,G0)}const X0=B(K0,[["render",Q0]]),Y0={},t1={class:"k-icon refresh",xmlns:"http://www.w3.org/2000/svg",viewBox:"0 0 512 512"},e1=m("path",{fill:"currentColor",d:"M496 40v160C496 213.3 485.3 224 472 224h-160C298.8 224 288 213.3 288 200s10.75-24 24-24h100.5C382.8 118.3 322.5 80 256 80C158.1 80 80 158.1 80 256s78.97 176 176 176c41.09 0 81.09-14.47 112.6-40.75c10.16-8.5 25.31-7.156 33.81 3.062c8.5 10.19 7.125 25.31-3.062 33.81c-40.16 33.44-91.17 51.77-143.5 51.77C132.4 479.9 32 379.5 32 256s100.4-223.9 223.9-223.9c79.85 0 152.4 43.46 192.1 109.1V40c0-13.25 10.75-24 24-24S496 26.75 496 40z"},null,-1),c1=[e1];function n1(o,l){return f(),y("svg",t1,c1)}const o1=B(Y0,[["render",n1]]),a1={},s1={xmlns:"http://www.w3.org/2000/svg",viewBox:"2 2 20 20"},l1=m("path",{fill:"currentColor",d:"M2.39 1.73L1.11 3L9 10.89V15.87C8.96 16.16 9.06 16.47 9.29 16.7L13.3 20.71C13.69 21.1 14.32 21.1 14.71 20.71C14.94 20.5 15.04 20.18 15 19.88V16.89L20.84 22.73L22.11 21.46L15 14.35V14.34L13 12.35L11 10.34L4.15 3.5L2.39 1.73M6.21 3L8.2 5H16.96L13.11 9.91L15 11.8V10.75L19.79 4.62C20.13 4.19 20.05 3.56 19.62 3.22C19.43 3.08 19.22 3 19 3H6.21M11 12.89L13 14.89V17.58L11 15.58V12.89Z"},null,-1),r1=[l1];function i1(o,l){return f(),y("svg",s1,r1)}const u1=B(a1,[["render",i1]]),d1={},f1={xmlns:"http://www.w3.org/2000/svg",viewBox:"2 2 20 20"},g1=m("path",{fill:"currentColor",d:"M15,19.88C15.04,20.18 14.94,20.5 14.71,20.71C14.32,21.1 13.69,21.1 13.3,20.71L9.29,16.7C9.06,16.47 8.96,16.16 9,15.87V10.75L4.21,4.62C3.87,4.19 3.95,3.56 4.38,3.22C4.57,3.08 4.78,3 5,3V3H19V3C19.22,3 19.43,3.08 19.62,3.22C20.05,3.56 20.13,4.19 19.79,4.62L15,10.75V19.88M7.04,5L11,10.06V15.58L13,17.58V10.05L16.96,5H7.04Z"},null,-1),p1=[g1];function _1(o,l){return f(),y("svg",f1,p1)}const m1=B(d1,[["render",_1]]),h1={},b1={xmlns:"http://www.w3.org/2000/svg",viewBox:"0 0 512 512"},C1=O0(`<g><g><path fill="currentColor" d="M256.005,13.477c-84.682,0-153.734,68.227-155.075,152.594c0.535-0.164,1.073-0.318,1.61-0.477
