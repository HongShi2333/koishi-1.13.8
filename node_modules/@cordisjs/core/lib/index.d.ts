...
export class Registry<C extends Context = Context> {
    ...
    get counter(): number;
    get size(): number;
    resolve(plugin: Plugin): ((ctx: Context, config: any) => void) | (Plugin.Constructor<Context, any> & Function);
    get(plugin: Plugin): MainScope<C> | undefined;
    has(plugin: Plugin): boolean;
    set(plugin: Plugin, state: MainScope<C>): MainScope<C> | undefined;
    delete(plugin: Plugin): MainScope<C> | undefined;
    keys(): IterableIterator<Plugin<Context, any>>;
    values(): IterableIterator<MainScope<C>>;
    entries(): IterableIterator<[Plugin<Context, any>, MainScope<C>]>;
    forEach(callback: (value: MainScope<C>, key: Plugin, map: Map<Plugin, MainScope<C>>) => void): void;
