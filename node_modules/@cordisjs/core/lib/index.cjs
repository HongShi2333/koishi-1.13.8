...
var Lifecycle = class {
  constructor(root) {
    this.root = root;
    (0, import_cosmokit.defineProperty)(this, Context.origin, root);
...
function createTraceable(ctx, value) {
  const proxy = new Proxy(value, {
    get: (target, name, receiver) => {
      if (name === symbols.origin || name === "caller")
        return ctx;
...
var Registry = class {
  constructor(root, config) {
    this.root = root;
    (0, import_cosmokit4.defineProperty)(this, Context.origin, root);
  ...
  constructor(config) {
    ...
    const attach = /* @__PURE__ */ __name((internal) => {
      ...
      for (const key of Object.getOwnPropertyNames(internal)) {
        ...
        (0, import_cosmokit5.defineProperty)(self[internal[key]["key"]], symbols.origin, self);
      }
    }, "attach");
...
var Service = class _Service {
  ...
  constructor(...args) {
    ...
    self.name = name;
    self.config = config;
    (0, import_cosmokit6.defineProperty)(self, symbols.origin, self.ctx);
  ...
  [symbols.extend](props) {
    ...
    (0, import_cosmokit6.defineProperty)(self, symbols.origin, caller);
