...
Schema.prototype.toJSON = /* @__PURE__ */ __name(function toJSON() {
  var _a2, _b;
  if (refs) {
    (_b = refs[_a2 = this.uid]) != null ? _b : refs[_a2] = JSON.parse(JSON.stringify({ ...this }));
    return this.uid;
  }
  refs = { [this.uid]: { ...this } };
...
Schema.prototype.i18n = /* @__PURE__ */ __name(function i18n(messages) {
  ...
  if (schema.dict) {
    schema.dict = (0, import_cosmokit.valueMap)(schema.dict, (inner, key) => {
      return inner.i18n((0, import_cosmokit.valueMap)(messages, (data) => {
        var _a2, _b;
        return (_b = (_a2 = getInner(data)) == null ? void 0 : _a2[key]) != null ? _b : data == null ? void 0 : data[key];
      }));
    });
  }
  if (schema.list) {
  ...
  if (schema.sKey) {
    schema.sKey = schema.sKey.i18n((0, import_cosmokit.valueMap)(messages, (data) => data == null ? void 0 : data.$key));
  }
  return schema;
}, "i18n");
...
Schema.prototype.toString = /* @__PURE__ */ __name(function toString(inline) {
  var _a2, _b;
  return (_b = (_a2 = formatters[this.type]) == null ? void 0 : _a2.call(formatters, this, inline)) != null ? _b : `Schema<${this.type}>`;
}, "toString");
...
Schema.resolve = /* @__PURE__ */ __name(function resolve(data, schema, options = {}, strict = false) {
  ...
  if ((0, import_cosmokit.isNullable)(data)) {
    ...
    while ((current == null ? void 0 : current.type) === "intersect" && (0, import_cosmokit.isNullable)(fallback)) {
      ...
      keys.forEach((key, index) => {
        ...
        switch (key) {
          ...
          case "callback": {
            ...
            (_b = schema.callback)["toJSON"] || (_b["toJSON"] = () => schema.callback.toString());
            break;
          }
          default:
