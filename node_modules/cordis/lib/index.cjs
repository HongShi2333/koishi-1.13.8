...
var _Lifecycle = class _Lifecycle {
  constructor(root) {
    this.root = root;
    (0, import_cosmokit.defineProperty)(this, Context.current, root);
    (0, import_cosmokit.defineProperty)(this.on("internal/listener", function(name, listener, prepend) {
    ...
    (0, import_cosmokit.defineProperty)(this.on("internal/error", (error) => {
      if (this._hooks["internal/error"].length > 1)
        return;
      console.error(error);
    }), Context.static, root.scope);
    (0, import_cosmokit.defineProperty)(this.on("internal/warning", (error) => {
  ...
  prepareEvent(type, args) {
    ...
    return [this.getHooks(name, thisArg), thisArg != null ? thisArg : this[Context.current]];
  }
  async parallel(...args) {
...
var _CordisError = class _CordisError extends Error {
  constructor(code, message) {
    super(message != null ? message : _CordisError.Code[code]);
    this.code = code;
  }
};
__name(_CordisError, "CordisError");
var CordisError = _CordisError;
((CordisError2) => {
  CordisError2.Code = {
    INACTIVE_EFFECT: "cannot create effect on inactive context"
  };
})(CordisError || (CordisError = {}));
var _EffectScope = class _EffectScope {
  ...
  effect(callback) {
    ...
    const wrapped = /* @__PURE__ */ __name(() => {
      if (!(0, import_cosmokit2.remove)(this.disposables, wrapped))
        return;
      return original();
    }, "wrapped");
  ...
  get ready() {
    return this.runtime.using.every((name) => !(0, import_cosmokit2.isNullable)(this.ctx[name]));
  }
  reset() {
    this.isActive = false;
  ...
  accept(...args) {
    ...
    return this.effect(() => {
      ...
      return () => (0, import_cosmokit2.remove)(this.acceptors, acceptor);
    });
  }
  decline(keys) {
...
var EffectScope = _EffectScope;
var _ForkScope = class _ForkScope extends EffectScope {
  constructor(parent, runtime, config, error) {
    super(parent, config);
    this.runtime = runtime;
    this.dispose = (0, import_cosmokit2.defineProperty)(parent.scope.collect(`fork <${parent.runtime.name}>`, () => {
      this.uid = null;
      this.reset();
...
__name(_ForkScope, "ForkScope");
var ForkScope = _ForkScope;
var _MainScope = class _MainScope extends EffectScope {
...
__name(_MainScope, "MainScope");
var MainScope = _MainScope;
...
var _Context = class _Context {
  ...
  static associate(object, name) {
    return new Proxy(object, {
      get(target, key, receiver) {
        ...
        if (!(caller == null ? void 0 : caller[_Context.internal][`${name}.${key}`]))
          return Reflect.get(target, key, receiver);
  ...
  constructor(config) {
    ...
    const attach = /* @__PURE__ */ __name((internal) => {
      ...
      for (const key of Object.getOwnPropertyNames(internal)) {
        const constructor = (_a = internal[key]["prototype"]) == null ? void 0 : _a.constructor;
        if (!constructor)
          continue;
        self[internal[key]["key"]] = new constructor(self, config);
        (0, import_cosmokit4.defineProperty)(self[internal[key]["key"]], _Context.current, self);
      }
    }, "attach");
  ...
  get(name) {
    ...
    if (isUnproxyable(value)) {
      (0, import_cosmokit4.defineProperty)(value, _Context.current, this);
      return value;
    }
  ...
  accessor(name, options) {
    const internal = _Context.ensureInternal.call(this.root);
    internal[name] || (internal[name] = { type: "accessor", ...options });
  }
  alias(name, aliases) {
    const internal = _Context.ensureInternal.call(this.root);
    ...
    for (const key of mixins) {
      this.accessor(key, {
        get() {
          ...
          if ((0, import_cosmokit4.isNullable)(service))
            return service;
  ...
  isolate(names, label) {
    ...
    for (const name of names) {
      self[_Context.shadow][name] = label ? (_d = (_c = (_b = (_a = this.realms)[label]) != null ? _b : _a[label] = /* @__PURE__ */ Object.create(null))[name]) != null ? _d : _c[name] = Symbol(name) : Symbol(name);
    }
    return self;
  }
};
__name(_Context, "Context");
__publicField(_Context, "config", Symbol.for("cordis.config"));
__publicField(_Context, "events", Symbol.for("cordis.events"));
__publicField(_Context, "static", Symbol.for("cordis.static"));
__publicField(_Context, "filter", Symbol.for("cordis.filter"));
__publicField(_Context, "expose", Symbol.for("cordis.expose"));
__publicField(_Context, "shadow", Symbol.for("cordis.shadow"));
/** @deprecated use `Context.current` instead */
__publicField(_Context, "source", Symbol.for("cordis.current"));
__publicField(_Context, "current", Symbol.for("cordis.current"));
__publicField(_Context, "internal", Symbol.for("cordis.internal"));
__publicField(_Context, "handler", {
  get(target, prop, ctx) {
  ...
  set(target, prop, value, ctx) {
    ...
    if (value instanceof Object) {
      (0, import_cosmokit4.defineProperty)(value, _Context.current, ctx);
    }
